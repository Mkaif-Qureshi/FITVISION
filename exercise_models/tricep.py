...
# Determine if the exercise is being performed properly
			if angle > lower_threshold and  angle < upper_threshold:
				cv2.putText(frame, "Proper Tricep Extension", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
			else:
				cv2.putText(frame, "Improve Tricep Extension", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
